...
namespace HotelProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20230731184124_mig_add_worklocation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("HotelProject.EntitiyLayer.Concrete.WorkLocation", null)
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("HotelProject.EntitiyLayer.Concrete.Contact", b =>
                {
                    b.HasOne("HotelProject.EntitiyLayer.Concrete.MessageCategory", null)
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("HotelProject.EntitiyLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("HotelProject.EntitiyLayer.Concrete.AppUser", null)
                        .WithMany()
